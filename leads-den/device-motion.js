(()=>{
const root=document.querySelector('#device-motion');if(!root)return;
if(matchMedia('(prefers-reduced-motion: reduce)').matches)return;
const section=root.querySelector('#sequence'),canvas=root.querySelector('#canvas'),surface=root.querySelector('.surface'),grid=root.querySelector('.layout-grid');
